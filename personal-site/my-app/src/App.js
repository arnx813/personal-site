...
function App() {
  return (
    ...
    flexWrap: 'wrap',
      ...
      <Typography color="primary" variant="h6" style={{ paddingTop: "2rem"}}>im building things. im exploring product, art, & design. im reading a lot. im studying cs & philosophy at dartmouth. and more.</Typography>
